...
const { searchDoctors, filterDoctors, viewDoctors, bookAppointment, loadFollowUpPage, PatientRequestFollowUp} = require('../../../controllers-clinic/patientViewController.js');
...
router.post('/PatientRequestFollowUp/:id', PatientRequestFollowUp);
