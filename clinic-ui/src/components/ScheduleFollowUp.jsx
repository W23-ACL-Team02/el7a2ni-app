...
const ScheduleFollowUp = () => {
    ...
    const getPatientsAndAppts = async () => {
      try {
        const response = await axios({
          method: 'get',
          url: 'http://localhost:3000/private/doctorPatient/selectFollowUpMenu',
  ...
  const schedulefollowup = async () => {
    ...
    try {
      ...
      const response = await axios.post('http://localhost:3000/private/doctorPatient/scheduleFollowUp',
        {
