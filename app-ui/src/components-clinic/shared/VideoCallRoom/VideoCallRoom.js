...
const VideoCallRoom = () => {
    ...
    return (
        <div className={styles.mainContainer}>
			<h1 style={{ textAlign: "center", color: '#fff' }}>Clinic Video Chat Room</h1>
		<div className="container">
			...
			<div className={styles.myId}>
				...
				<select defaultValue={idToCall} id="named-select" name="user-select"  onChange={handleChange} style={{ width: "120px" }}>
