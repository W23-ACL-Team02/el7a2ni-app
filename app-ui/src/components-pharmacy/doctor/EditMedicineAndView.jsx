...
export default function EditMedicineAndView() {
    ...
    const filterPrescriptions = () => {
      ...
      return {
        newPrescriptions: newPrescriptions.filter((prescription) => dateFilter(prescription) && filledFilter(prescription)),
        oldPrescriptions: oldPrescriptions.filter((prescription) => dateFilter(prescription) && filledFilter(prescription)),      };
  };
  ...
  return (
    <div className="table-container">
      ...
      <div>
        ...
        <div>
        <EditSelectedPrescriptions prescription={detailedPrescription} onPrescriptionUpdate={handlePrescriptionUpdate} />
        </div>
      </div>
    </div>
  );
