...
import PatientNavBar from '../components-main/DoctorNavBar'
            ...
            <div className='top'>
                ...
                <div  style={{display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', alignContent:'center'}}>
                    ...
                    <Card height={400} width={350} >
                        ...
                        <div className='line' style={{width: 200}}></div>
                        <button style={{width: 200, height: 150, borderRadius: 40, fontSize: 20, marginTop: 10, marginBottom: 20, alignSelf: 'center'}} onClick={() => {navigate('/')}}>Edit Prescriptions</button>
                    </Card> 
                </div>
            </div>
