        ...
        <div className='main'>
            ...
            <div className='top'>
                <Card height={500} width={350}>
                    ...
                    <button style={{width: 200, height: 60, borderRadius: 40, fontSize: 20, marginTop: 10, marginBottom: 20, alignSelf: 'center'}}>Book Appointment</button>
                    ...
                    <button style={{width: 200, height: 60, borderRadius: 40, fontSize: 20, marginTop: 10, marginBottom: 20, alignSelf: 'center'}}>Start Video Call</button>
                </Card>
                <Card height={500} width={350}>
                    ...
                    <button style={{width: 200, height: 60, borderRadius: 40, fontSize: 20, marginTop: 10, marginBottom: 20, alignSelf: 'center'}}>Browse Medicine</button>
            ...
            <Card height={100} width={750}>
                <div className='bottom'>
                    ...
                    <button style={{width: 200, height: 60, borderRadius: 40, fontSize: 20, margin: 10, alignSelf: 'center'}}>Subscribe</button>
                </div>
            </Card>
        </div>
    )
